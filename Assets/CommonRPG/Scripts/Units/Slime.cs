...
namespace CommonRPG
{
    public class Slime : MonsterBase
    {
        ...
        //protected override void DoDamage(bool isStartingAttackCheck)
        //{
        //    LayerMask layerMask = LayerMask.GetMask("Character");
        //    if (Physics.Raycast(transform.position, transform.forward, out RaycastHit hit, base.attackRange, layerMask)) 
        //    {
        ...
        //protected override void Attack(Transform targetTransform)
        //{
        //    SlimeAnimController slimeAnimController = (SlimeAnimController)animController;
        //    Debug.Assert(slimeAnimController);
